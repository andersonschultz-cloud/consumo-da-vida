...
function _hardcodedFallback(selic) {
  ...
  return [
    ...
    { id:'selic24', name:'Tesouro Selic 2031', sub:'Selic + 0,07%', color:'#2563EB', taxable:true,  on:true, derive:{base:'selicAdd',add:0.1806}, logo:'https://logo.clearbit.com/tesourodireto.com.br', product:'Título público federal — Tesouro Direto',   rate:round2(s+0.07) },
